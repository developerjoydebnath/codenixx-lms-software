...
export default function LogoForInvoice({ className }) {
    return (
        <svg
            version="1.1"
            id="Layer_1"
        ...
        >
            <g>
                <g>
                    <circle className="fill-gray-500/20" cx="394.55" cy="300.71" r="145.2" />
                    <g>
                        <circle className="fill-gray-500/20" cx="539.76" cy="300.71" r="145.2" />
                        <circle className="fill-gray-500/20" cx="249.35" cy="300.71" r="145.2" />
                    </g>
                </g>
                <path
		...
		c-4.85,0-8.78,3.93-8.78,8.78v0C539.34,251.29,543.27,255.22,548.11,255.22z"
			...
			L275.19,378.26z"
                    />
                    <path className="fill-black/70" d="M285.9,368.12h2.62v12.74h-2.62V368.12z" />
                    <path
                        className="fill-black/70"
