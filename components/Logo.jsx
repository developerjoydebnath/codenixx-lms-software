...
export default function Logo({ className }) {
    return (
        ...
        >
            <g>
                <g>
                    <circle className="fill-base-400/15 dark:fill-white/10" cx="394.55" cy="300.71" r="145.2" />
                    <g>
                        <circle className="fill-base-400/15 dark:fill-white/10" cx="539.76" cy="300.71" r="145.2" />
                        <circle className="fill-base-400/15 dark:fill-white/10" cx="249.35" cy="300.71" r="145.2" />
                    </g>
                </g>
                <path
                    className="fill-base-500"
                    d="M548.11,255.22h4.27c4.85,0,8.78-3.93,8.78-8.78v0c0-4.85-3.93-8.78-8.78-8.78h-4.27
		c-4.85,0-8.78,3.93-8.78,8.78v0C539.34,251.29,543.27,255.22,548.11,255.22z"
                />
                <g>
                    <path
                        className="fill-base-500"
                        d="M187.64,380.86v-12.74h7.34c1.7,0,3,0.29,3.89,0.86c0.89,0.57,1.33,1.42,1.33,2.55c0,0.72-0.18,1.29-0.53,1.7
			...
			c-0.43-0.04-0.9-0.07-1.4-0.07h-4.9V378.69z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M211.12,375.54v3.13h9.82v2.19h-12.44v-12.74h12.42v2.19h-9.81v3.17h8.03v2.07H211.12z"
                    />
                    <path
                        className="fill-base-500"
                        d="M251.11,375.23v-7.11h2.62v7.38c0,0.84-0.12,1.57-0.37,2.2c-0.24,0.63-0.59,1.16-1.03,1.6
			...
			c0.85,0,1.62-0.09,2.29-0.29c0.68-0.19,1.21-0.54,1.61-1.06C250.91,376.99,251.11,376.23,251.11,375.23z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M275.19,378.26l-0.83,0.33v-10.47h2.62v12.74h-2.62l-10.3-10.06l0.83-0.33v10.4h-2.62v-12.74h2.62
			L275.19,378.26z"
                    />
                    <path className="fill-base-500" d="M285.9,368.12h2.62v12.74h-2.62V368.12z" />
                    <path
                        className="fill-base-500"
                        d="M305,381.12c-1.69,0-3.14-0.27-4.34-0.8c-1.2-0.53-2.12-1.29-2.76-2.28c-0.64-0.98-0.95-2.16-0.95-3.54
			...
			c0.46,0.64,1.09,1.12,1.91,1.44C303.03,378.69,303.96,378.85,305,378.85z M303.72,380.01h2.56v4.78h-2.56V380.01z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M332.82,375.23v-7.11h2.62v7.38c0,0.84-0.12,1.57-0.37,2.2c-0.24,0.63-0.59,1.16-1.03,1.6
			...
			c0.68-0.19,1.21-0.54,1.61-1.06C332.62,376.99,332.82,376.23,332.82,375.23z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M346.6,375.54v3.13h9.82v2.19h-12.44v-12.74h12.42v2.19h-9.81v3.17h8.03v2.07H346.6z"
                    />
                    <path
                        className="fill-base-500"
                        d="M374.89,380.86v-12.74h7.34c1.7,0,3,0.29,3.89,0.86c0.89,0.57,1.33,1.42,1.33,2.55c0,0.72-0.18,1.29-0.53,1.7
			c-0.35,0.41-0.86,0.72-1.51,0.92c-0.65,0.2-1.41,0.32-2.29,0.37l0.08-0.14c0.64,0.01,1.25,0.06,1.82,0.14
			c0.57,0.08,1.07,0.22,1.51,0.43c0.43,0.21,0.78,0.5,1.02,0.87c0.25,0.37,0.37,0.87,0.37,1.47c0,0.79-0.21,1.44-0.63,1.96
			...
			c-0.43-0.04-0.9-0.07-1.4-0.07h-4.9V378.69z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M398.38,375.54v3.13h9.82v2.19h-12.44v-12.74h12.42v2.19h-9.81v3.17h8.03v2.07H398.38z"
                    />
                    <path
                        className="fill-base-500"
                        d="M441.53,376.27c-0.12,1.03-0.48,1.9-1.08,2.62c-0.6,0.72-1.42,1.27-2.46,1.65c-1.04,0.38-2.27,0.57-3.7,0.57
			...
			c0.87,0,1.61-0.1,2.23-0.31c0.62-0.21,1.14-0.51,1.54-0.9c0.4-0.39,0.69-0.86,0.88-1.38H441.53z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M449.61,380.86v-12.74h8.64c0.98,0,1.84,0.13,2.57,0.4c0.73,0.27,1.3,0.69,1.7,1.26
			...
			V374.11z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M474,375.54v3.13h9.82v2.19h-12.44v-12.74h12.42v2.19H474v3.17h8.03v2.07H474z"
                    />
                    <path
                        className="fill-base-500"
                        d="M490.85,380.86l5.99-12.74h2.84l6.04,12.74h-2.86l-5.24-11.48h1.26l-5.2,11.48H490.85z M494.02,378.08v-2.19
			h8.42v2.19H494.02z"
                    />
                    <path
                        className="fill-base-500"
                        d="M510.34,368.12h13.43v2.19h-13.43V368.12z M515.76,370.03h2.62v10.83h-2.62V370.03z"
                    />
                    <path
                        className="fill-base-500"
                        d="M576.73,380.86l-5.63-12.74h2.89l4.82,11.5h-0.9l4.8-11.5h2.86L580,380.86H576.73z"
                    />
                    <path
                        className="fill-base-500"
                        d="M595.61,375.54v3.13h9.82v2.19h-12.44v-12.74h12.42v2.19h-9.81v3.17h8.03v2.07H595.61z"
                    />
                </g>
                <g>
                    <path
                        className="fill-base-500"
                        d="M206.46,264.16c-5.35-2.56-11.29-4.13-17.72-4.76c-2.13-0.23-4.33-0.33-6.56-0.33
			...
			c0-8.96-2.07-16.64-6.17-23.04C219.16,272.46,213.55,267.57,206.46,264.16z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M309.98,284.89c-1.26-5.02-3.23-9.44-5.91-13.25c-2.73-3.88-6.45-6.94-11.15-9.19
			...
			C309.98,307.16,308.86,311.86,306.62,316.02z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M412.93,264.26c-6.51-3.44-14.63-5.17-24.36-5.17c-9.41,0-17.69,1.75-24.86,5.25
			...
			c7.22,0,13.07,1.72,17.56,5.17c4.48,3.44,6.94,8.23,7.38,14.36H360.35z"
                    ...
                    <path
                        className="fill-base-500"
                        d="M517.11,267.04c-2.9-2.68-6.34-4.68-10.34-5.99c-3.99-1.31-8.34-1.97-13.04-1.97
			...
			C522.25,273.03,520,269.73,517.11,267.04z"
                    ...
                    <polygon
                        className="fill-base-500"
                        points="657.62,260.89 635.48,260.89 613.72,288.31 590.52,260.89 568.04,260.89 603.14,301.23 568.04,342.6 
			590.36,342.6 613.4,313.4 637.44,342.6 659.76,342.6 623.98,300.43 		"
                    />
                    <polygon
                        className="fill-base-500"
                        points="716.35,300.43 749.99,260.89 727.84,260.89 706.09,288.31 682.89,260.89 660.41,260.89 
			695.51,301.23 660.41,342.6 682.73,342.6 705.77,313.4 729.81,342.6 752.12,342.6 		"
                    />
                    <path
                        className="fill-base-500"
                        d="M552.38,261.01h-4.27c-2.5,0-4.9-0.44-7.14-1.22v121.07h18.37V259.85
