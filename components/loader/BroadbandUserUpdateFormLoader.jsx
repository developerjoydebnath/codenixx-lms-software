...
export default function BroadbandUserUpdateFormLoader({ children, className = "", titleClass = "", title = "" }) {
    return (
        <FormLayoutLoader>
            ...
            <SectionLoader childClass="grid gap-4 sm:grid-cols-2 grid-cols-1">
                <InputLoader />
                <InputLoader />
            </SectionLoader>
            <SectionLoader childClass="grid gap-4 sm:grid-cols-2 md:grid-cols-2">
                <InputLoader />
                <InputLoader />
                <InputLoader />
            </SectionLoader>
